...
class AdventureController extends Controller
{
    ...
    #[OA\Get(
        path: '/api/adventures/{adventure}',
        summary: 'Get single adventure activity details',
        description: 'Retrieves single adventure activity details by ID.',
        tags: ['Adventures'],
        parameters: [
            new OA\Parameter(name: 'adventure', in: 'path', required: true, schema: new OA\Schema(type: 'integer')),
        ],
        responses: [
            new OA\Response(
                response: 200,
            ...
            new OA\Response(response: 404, description: 'Adventure not found'),
        ]
    )]
