...
<head>
    ...
    <title>Tour Inquiry Received</title>
    <style>
        body {
...
<body>
    <div class="card">
        ...
        <div class="body">
            <p>Dear {{ $tourInquiry->name }},</p>
            <p>Thank you for submitting your booking inquiry for <strong>{{ $tourInquiry->tour?->title ?? 'our tour package' }}</strong>. Our team has received your request and will reach out to you shortly.</p>
