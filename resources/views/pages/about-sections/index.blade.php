    ...
    <div class="ts-page-wrapper">
        ...
        <div class="ts-page-header">
            <div>
                ...
                <p>
                    View and manage the About Section content, globe locations and customer avatars.
                </p>
            </div>

            @if ($aboutSections->total() === 0)
                <a href="{{ route('admin.about-sections.create') }}" class="ts-primary-btn">
                    <span>+</span> Add About Section
                </a>
            @endif
        </div>
                    ...
                    <tbody>
                        @forelse ($aboutSections as $aboutSection)
                            <tr>
                                ...
                                <td>
                                    <strong>{{ $aboutSection->main_heading }}</strong>
                                    <small>{{ \Illuminate\Support\Str::limit(strip_tags($aboutSection->description), 65) }}</small>
                                </td>
                                <td>{{ $aboutSection->mission_title ?: 'Not provided' }}</td>
                                <td>{{ $aboutSection->focus_title ?: 'Not provided' }}</td>
                                <td>{{ number_format($aboutSection->customer_count ?? 0) }}</td>
                                <td>{{ $aboutSection->globe_locations_count ?? 0 }}</td>
                                <td>
                                    <div class="table-avatar-wrapper">
                                        <div class="table-avatar-list">
                                            ...
                                            @empty
                                                <span class="no-avatar-text">No images</span>
                                            @endforelse
                                ...
                                <td>
                                    <span class="status-badge {{ $aboutSection->status ? 'status-active' : 'status-inactive' }}">
                            ...
                            <tr>
                                <td colspan="9">
                                    <div class="ts-empty-state">
                                        ...
                                        <p>
                                            Create an About Section to manage your website content.
                                        </p>
