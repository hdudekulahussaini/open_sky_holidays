    ...
    <div class="ts-page-wrapper">
        ...
        <div class="ts-page-header">
            <div>
                ...
                <p>
                    Manage travel support sections and contact options.
                </p>
            </div>

            <a href="{{ route('admin.travel-support.create') }}"
        ...
        <div class="ts-list-card">
            ...
            <div class="ts-list-card-header">
                <div>
                    <h2>Travel Support List</h2>

                    <p>
                        Total records:
                        <strong>{{ $travelSupports->total() }}</strong>
                    </p>
                </div>
            </div>
            ...
            <div class="ts-table-wrapper">
                <table class="ts-table">
                    ...
                    <tbody>
                        @forelse ($travelSupports as $support)
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div class="ts-actions">
                                        <a href="{{ route('admin.travel-support.edit', $support) }}"
                                            class="ts-action-btn ts-edit-btn">
                                            Edit
                                        </a>
                                        <form action="{{ route('admin.travel-support.destroy', $support) }}"
                                            method="POST"
                                            onsubmit="return confirm('Are you sure you want to delete this support section?')">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="ts-empty-state">
                                        ...
                                        <p>
                                            Add your first Travel Support record.
                                        </p>
