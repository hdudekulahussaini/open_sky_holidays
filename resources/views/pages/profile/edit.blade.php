...
<div class="container-fluid">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Manage your account name, email address, and security password.</p>
        </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            >
                            <button class="btn btn-outline-secondary px-3 toggle-password-btn" type="button"
