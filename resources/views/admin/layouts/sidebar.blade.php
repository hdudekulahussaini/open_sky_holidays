...
<aside class="sidebar" id="adminSidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <!-- Hero & Banners Dropdown -->
        <div class="nav-dropdown-wrapper {{ request()->routeIs('admin.heroes.*', 'admin.page-banners.*') ? 'open' : '' }}">
            ...
            <div class="nav-dropdown-menu">
                <a href="{{ route('admin.heroes.index') }}"
                    ...
                    <svg class="submenu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <!-- Why Choose Us -->
        <a href="{{ route('admin.why-choose-sections.index') }}"
